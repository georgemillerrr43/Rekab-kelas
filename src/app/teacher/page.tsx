  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 stagger-enter">
        <Link href="/teacher/attendance" className="glass-card-hover p-5 group">
        ...
        <Link href="/teacher/approval" className="glass-card-hover p-5 group">
        ...
        <Link href="/recap" className="glass-card-hover p-5 group">
