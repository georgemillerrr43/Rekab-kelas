  ...
  return (
    <div className="max-w-lg mx-auto space-y-6 pt-4">
      <div className="page-header">
        <span className="badge badge-gray mb-2">Profile</span>
      ...
      <div className="glass-card p-6">
        <div className="flex items-center gap-4 mb-6 pb-4 border-b border-[var(--border-subtle)]">
          ...
          <div>
            <h2 className="font-bold text-[var(--text-primary)]">Admin</h2>
            <p className="text-sm text-[var(--text-muted)]">Role: Administrator</p>
          </div>
        </div>
        ...
        {pwMsg && (
          <div
            className={`p-3 rounded-[var(--radius-input)] text-sm font-semibold border mb-4 ${
              pwMsg.type === 'success'
