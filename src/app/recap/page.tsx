...
function RekapPageInner() {
  ...
  useEffect(() => {
    ...
    (async () => { try { setRekapList((await (await fetch(`/api/recap?kelas=${kelas}&bulan=${bulan}`)).json()).rekap || []); } catch { /* empty */ } })();
  }, [kelas, bulan, tab]);
                    ...
                    {[
                      ...
                      <div key={s.label} className="stat-card p-3 md:p-4 flex items-start gap-2 md:gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="h-1 rounded-full bg-[var(--bg-glass)] mt-1.5 md:mt-2 overflow-hidden">
